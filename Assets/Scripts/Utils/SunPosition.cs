...
namespace Utils {
     ...
     * SOURCE: http://guideving.blogspot.co.uk/2010/08/sun-position-in-c.html
     ...
     */  
        public static SunAngle CalculateSunPosition(  
        ...
        {  
            ...
            return new SunAngle(altitude * Rad2Deg, azimuth * Rad2Deg);
//            // Altitude  
...
//            Console.WriteLine("Azimuth: " + azimuth * Rad2Deg);  
    ...
    */  
    ...
    public class SunAngle {
        ...
        public SunAngle(double altitude, double azimuth) {
            Altitude = altitude;
            Azimuth = azimuth;
        }
    }
